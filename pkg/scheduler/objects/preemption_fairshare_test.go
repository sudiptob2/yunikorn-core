...
func TestQueuePreemptionSnapshot_GetFairShareResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := child.GetFairShareResourceWithSiblingCount(tt.activeSiblings)
...
func TestQueuePreemptionSnapshot_GetPreemptableResourceForPolicy(t *testing.T) {
	// Test that the policy routing works correctly
	...
	// Test default policy
	result := snapshot.GetPreemptableResourceForPolicy(policies.DefaultPreemptionPolicy)
	if result == nil {
		t.Error("Expected non-nil result for default policy")
	}

	// Test fair share policy
	result = snapshot.GetPreemptableResourceForPolicy(policies.FairSharePreemptionPolicy)
	if result == nil {
		t.Error("Expected non-nil result for fair share policy")
	}
}

func TestQueuePreemptionSnapshot_GetPreemptableResourceForFairShare(t *testing.T) {
	...
	result := child.GetPreemptableResourceForFairShare(2)
	if result == nil {
	...
	result = child.GetPreemptableResourceForFairShare(1)
	if result == nil {
...
func TestQueuePreemptionSnapshot_FairShareWithLimitedParentCapacity(t *testing.T) {
	...
	fairShare := child.GetFairShareResourceWithSiblingCount(2)
...
func TestQueuePreemptionSnapshot_DeeplyNestedQueueStructure(t *testing.T) {
	...
	fairShare := level2.GetFairShareResourceWithSiblingCount(2)
	...
	result := level2.GetPreemptableResourceForFairShare(2)
	...
	result = level2OverAllocated.GetPreemptableResourceForFairShare(2)
	if result == nil || result.IsEmpty() {
...
func TestQueuePreemptionSnapshot_FairShareWithRemainingGuaranteedCheck(t *testing.T) {
	...
	result := childWithRemaining.GetPreemptableResourceForFairShare(2)
	if result == nil {
...
func TestQueuePreemptionSnapshot_FairShareGuaranteeProtection(t *testing.T) {
	...
	result1 := child1.GetPreemptableResourceForFairShare(2) // Fair share = 40/2 = 20
	...
	result2 := child2.GetPreemptableResourceForFairShare(2) // Fair share = 40/2 = 20
	...
	result3 := child3.GetPreemptableResourceForFairShare(2) // Fair share = 40/2 = 20
	...
	result4 := child4.GetPreemptableResourceForFairShare(2) // Fair share = 40/2 = 20
